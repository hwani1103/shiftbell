...
**Claude 이어서 할 작업:** 2026-09-15 출시 적합성 재검토(`g6/recheck_2026_09_15/`) AUD-01·02·03·05·06·07·08 코드 수정 + 회귀 테스트 완료(작업 트리, 커밋 전 - `fix_record.md`). AUD-04(백그라운드 울림 지속)는 실기기 게이트. 남은 것은 사용자 실기기(바탕화면 테스트 1~15, `g6/device_test_plan.md`)·Play 내부 테스트·Console, G6 판정(`g6/release_gate.md` 비어 있음)
