...
**Claude 이어서 할 작업:** T06 — G1 수정 진행중 (`shiftbell-g1`, 기준 `94ff08f`). 완료(WIP): #3·#14·#23 `97c72fc`, #13 `47909d3`, #4 `15a48ad`, #16·#27(+#20 예약 API) `2763e04`, #26·#31 A `64a2130`·B `bef9f58`, #11·#12·#28 `7b56d3c`. 다음 #5·#10·#17·V6(#20 API는 반영됨). 진행 기록은 g1/handoff.md
