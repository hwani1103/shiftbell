...
-- Origin: reconstructed; user_version=4.
BEGIN TRANSACTION;
...
ALTER TABLE shift_schedule ADD COLUMN active_shift_types TEXT;
...
INSERT INTO shift_schedule (id, is_regular, pattern, today_index, shift_types, start_date, shift_colors, assigned_dates, active_shift_types) VALUES (1, 1, 'Day,Night,Off', 0, 'Day,Night,Off', '2026-09-14T00:00:00.000', '{"Day":4280391411,"Night":4288423856}', '{"2026-09-16":"Night"}', 'Day,Night');
