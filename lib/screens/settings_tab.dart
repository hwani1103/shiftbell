    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? Colors.orange.shade100 : Theme.of(context).colorScheme.surface,
            borderRadius: BorderRadius.circular(8.r),
            border: Border.all(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                fontSize: 13.sp,
                fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
                color: isSelected ? (Theme.of(context).brightness == Brightness.dark ? Colors.white : Colors.orange.shade800) : Theme.of(context).colorScheme.onSurfaceVariant,
              ),
            ),
          ),
        ),
