...
-- Historical source: 7ce304f324a2b41f53d3ac502461d0816a66baca:lib/services/database_service.dart
-- Origin: historical_onCreate; user_version=6.
BEGIN TRANSACTION;
...
INSERT INTO alarm_types (id, name, emoji, sound_file, volume, is_preset, duration) VALUES (1, 'Sound', 'S', 'alarmbell1', 0.43, 1, 7);
INSERT INTO alarm_types (id, name, emoji, sound_file, volume, is_preset, duration) VALUES (2, 'Vibrate', 'V', '', 0.0, 1, 7);
INSERT INTO alarm_types (id, name, emoji, sound_file, volume, is_preset, duration) VALUES (3, 'Silent', 'M', '', 0.0, 1, 7);
INSERT INTO alarm_types (id, name, emoji, sound_file, volume, is_preset, duration) VALUES (41, 'Personal', 'P', 'alarmbell2', 0.35, 0, 7);
