...
-- Origin: historical_onCreate; user_version=23.
BEGIN TRANSACTION;
...
INSERT INTO date_schedules (id, date, content, start_minutes, duration_minutes, color_index, icon_index, style_index, font_index, predicted_category, is_user_corrected, notify_enabled, notify_offset_minutes, created_at, updated_at) VALUES (801, '2026-09-15', 'Team meeting', 540, 30, 2, 1, 1, 1, 'work', 1, 1, 15, '2026-09-14T05:00:00.000', '2026-09-14T05:00:00.000');
