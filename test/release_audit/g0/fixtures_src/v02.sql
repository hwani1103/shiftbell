...
-- Origin: historical_onCreate; user_version=2.
BEGIN TRANSACTION;
...
INSERT INTO shift_schedule (id, is_regular, pattern, today_index, shift_types, start_date, shift_colors) VALUES (1, 1, 'Day,Night,Off', 0, 'Day,Night,Off', '2026-09-14T00:00:00.000', '{"Day":4280391411,"Night":4288423856}');
