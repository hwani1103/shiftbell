...
-- Historical source: 120b8103eed42e99ec8cc7e49e27a660b9d8692b:lib/services/database_service.dart
-- Origin: historical_onCreate; user_version=12.
BEGIN TRANSACTION;
...
CREATE INDEX idx_date_memos_date ON date_memos(date);
